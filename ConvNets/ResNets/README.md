...
## Summary & Keys takeaways

Well, basically the rule was like: "the deeper the networks, the better".
Indeed, as you must know, the inner advantage of NN is their natural ability to learn low/mid/high level features. So in theory, the “levels” of features can be enriched by the number of stacked layers (depth) and by the time many visual recognition tasks have greatly benefited from very deep models.

<img src="img/ResNet_meme.jpeg" alt="ResNet meme" width="400" height="500"/>
...
<img src="img/ResNet_Paper_3.png" alt="ResNet meme" width="400" height="200"/>
